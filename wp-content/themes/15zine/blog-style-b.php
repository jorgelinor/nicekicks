...
<article id="post-<?php the_ID(); ?>" <?php post_class( "cb-blog-style-b cb-module-a cb-article cb-article-row-2 cb-article-row cb-img-above-meta clearfix cb-separated cb-no-$cb_count" ); ?> role="article" data-post-num="<?php echo intval( $current_post ); ?>" data-post-style="b">
