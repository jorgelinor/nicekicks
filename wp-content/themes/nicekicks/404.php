	...
	<div class="post hentry">
		...
		<div class="entry-content">
			...
			<div class="archive-page">
				...
				<ul>
					<?php if (function_exists('fc_cache'))
							fc_cache('wp_list_pages',array( 'title_li=' ));
						else
				...
				<ul>
					<?php 
						if (function_exists('fc_cache'))
							fc_cache('wp_list_categories',array('sort_column=name&title_li=') ); 
						else
			...
			<div class="archive-page">
				...
				<ul>
					<?php if (function_exists('fc_cache'))
							fc_cache('wp_list_authors',array( 'exclude_admin=0&optioncount=1' )); 
						else
				...
				<ul>
					<?php if (function_exists('fc_cache'))
							fc_cache('wp_get_archives',array( 'type=monthly' ));
						else
				...
				<ul>
					<?php if (function_exists('fc_cache'))
							fc_cache('wp_get_archives',array( 'type=postbypost&limit=100' )); 
						else
