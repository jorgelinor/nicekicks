...
<div class="boxed">
	...
	<?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
		...
		<textarea name="group-desc" id="group-desc" class="form-control" aria-required="true"><?php bp_group_description_editable(); ?></textarea>
		...
		<p><input type="submit" value="<?php _e( 'Save Changes', 'buddypress' ); ?>" id="save" name="save" class="btn btn-success" /></p>
	...
	<?php if ( bp_is_group_admin_screen( 'group-avatar' ) ) : ?>
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
				...
				<p>
					...
					<input type="submit" name="upload" id="upload" class="btn btn-success small-top" value="<?php _e( 'Upload Image', 'buddypress' ); ?>" />
		...
		<div class="bp-widget">
			...
			<?php if ( bp_group_has_members( 'per_page=15&exclude_banned=false' ) ) : ?>
				...
				<?php if ( bp_group_member_needs_pagination() ) : ?>
					...
					<div class="pagination reply-wrap no-ajax">
