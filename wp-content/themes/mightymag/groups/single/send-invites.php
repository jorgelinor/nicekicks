			...
			<?php if ( bp_group_has_invites() ) : ?>
				...
				<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
					...
					<li id="<?php bp_group_invite_item_id(); ?>" class="boxed middle-top">
						...
						<span class="pull-left group-members-avatar"><?php bp_group_invite_user_avatar(); ?></span>
						...
						<div class="reply-wrap">
							...
							<div class="action">
								<a class="btn btn-xs btn-danger" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'buddypress' ); ?></a>
