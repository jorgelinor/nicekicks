		...
		<div id="content" class="site-content" role="main">
				...
				<header class="entry-header boxed">
					...
					<?php do_action( 'bp_before_create_group_content_template' ); ?>
						...
						<h1 class="entry-title"><?php _e( 'Create a Group', 'buddypress' ); ?> &nbsp;<a class="btn btn-primary pull-right" href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_groups_root_slug() ); ?>"><?php _e( 'Groups Directory', 'buddypress' ); ?></a></h1>
				...
				<div class="item-list-tabs no-ajax" id="group-create-tabs" role="navigation">
					...
					<div class="item-body boxed" id="group-create-body">
						...
						<?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
							...
							<textarea name="group-desc" id="group-desc" class="form-control" aria-required="true"><?php bp_new_group_description(); ?></textarea>
						...
						<?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
							...
							<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
								...
								<div class="main-column">
									...
									<p>
										<input type="file" name="file" id="file" class="btn btn-success pull-left" />
										<input type="submit" name="upload" id="upload" class="btn btn-success pull-right" value="<?php _e( 'Upload Image', 'buddypress' ); ?>" />
										<input type="hidden" name="action" id="action" value="bp_avatar_upload" />
									</p>
									<div class="clear"></div>
									<p class="small-top"><?php _e( 'To skip the avatar upload process, hit the <strong>"Next Step"</strong> button.', 'buddypress' ); ?></p>
								</div><!-- .main-column -->
								...
								<div class="main-column">
									...
									<?php if ( bp_group_has_invites() ) : ?>
										...
										<?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
											...
											<li id="<?php bp_group_invite_item_id(); ?>" class="boxed middle-top">
												
												<div class="item-avatar">
												<?php bp_group_invite_user_avatar(); ?>
												</div>
												
												<cite class="fn"><?php bp_group_invite_user_link(); ?></cite><br />
												<span class="activity"><?php bp_group_invite_user_last_active(); ?></span>
												
												<div class="clear"></div>
												
												<div class="action reply-wrap">
													<a class="btn btn-xs btn-success" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'buddypress' ); ?></a>
												</div>
											</li>
						...
						<?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
							...
							<div class="submit" id="previous-next">
								...
								<?php if ( !bp_is_first_group_creation_step() ) : ?>
									...
									<input type="button" value="<?php _e( 'Back to Previous Step', 'buddypress' ); ?>" id="group-creation-previous" name="previous" onclick="location.href='<?php bp_group_creation_previous_link(); ?>'" class="btn btn-success" />
								...
								<?php if ( bp_is_first_group_creation_step() ) : ?>
									...
									<input type="submit" value="<?php _e( 'Create Group and Continue', 'buddypress' ); ?>" id="group-creation-create" name="save" class="btn btn-success" />
