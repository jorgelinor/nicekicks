...
<form action="<?php bp_the_profile_group_edit_form_action(); ?>" method="post" id="profile-edit-form" class="standard-form <?php bp_the_profile_group_slug(); ?>">
	...
	<?php do_action( 'bp_before_profile_field_content' ); ?>
		...
		<ul class="button-nav reply-wrap">
		...
		<?php while ( bp_profile_fields() ) : bp_the_profile_field(); ?>
			...
			<div<?php bp_field_css_class( 'editfield' ); ?>>
				...
				<?php else : ?>
					<div class="field-visibility-settings-notoggle pull-left" id="field-visibility-settings-toggle-<?php bp_the_profile_field_id() ?>">
						<?php printf( __( 'This field can be seen by: <strong class="current-visibility-level cat-color">%s</strong>', 'buddypress' ), bp_get_the_profile_field_visibility_level_label() ) ?>
					</div>
				<?php endif ?>
	...
	<div class="submit">
		<input type="submit" name="profile-group-edit-submit" id="profile-group-edit-submit" class="btn btn-success pull-right" value="<?php _e( 'Save Changes', 'buddypress' ); ?> " />
	</div>
