<div id="message-thread" role="main">
	...
	<?php if ( bp_thread_has_messages() ) : ?>
		...
		<p id="message-recipients">
			...
			<a class="btn btn-xs btn-danger confirm" href="<?php bp_the_thread_delete_link(); ?>" title="<?php _e( "Delete Message", "buddypress" ); ?>"><?php _e( 'Delete', 'buddypress' ); ?></a> &nbsp;
		</p>
		...
		<?php while ( bp_thread_messages() ) : bp_thread_the_message(); ?>
			...
			<div class="message-box <?php bp_the_thread_message_alt_class(); ?>">
				...
				<div class="message-metadata">
					...
					<cite class="fn"><a href="<?php bp_the_thread_message_sender_link(); ?>" title="<?php bp_the_thread_message_sender_name(); ?>"><?php bp_the_thread_message_sender_name(); ?></a></cite> <span class="activity"><?php bp_the_thread_message_time_since(); ?></span>
		...
		<form id="send-reply" action="<?php bp_messages_form_action(); ?>" method="post" class="">

			<div class="message-box message-box-txt">
				...
				<div class="message-metadata">
					...
					<div class="avatar-box">
						...
						<strong class="cat-color"><?php _e( 'Send a Reply', 'buddypress' ); ?></strong>
					</div>
				...
				<div class="message-content">
					...
					<div class="submit">
						<input type="submit" class="btn btn-success small-top pull-right" name="send" value="<?php _e( 'Send Reply', 'buddypress' ); ?>" id="send_reply_button"/>
					</div>
