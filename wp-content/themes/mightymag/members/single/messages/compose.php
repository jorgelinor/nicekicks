<h4><?php _e("Compose a new message", 'buddypress'); ?></h4>
...
<form action="<?php bp_messages_form_action('compose'); ?>" method="post" id="send_message_form" class="standard-form" role="main" enctype="multipart/form-data">
	...
	<div class="submit">
		<input type="submit" value="<?php _e( "Send Message", 'buddypress' ); ?>" name="send" id="send" class="btn btn-success pull-right" />
	</div>
