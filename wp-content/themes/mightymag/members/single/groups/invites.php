		...
		<?php while ( bp_groups() ) : bp_the_group(); ?>
			...
			<li class="boxed clearfix">
				...
				<div class="action reply-wrap clearfix">
					<a class="btn btn-xs btn-success accept" href="<?php bp_group_accept_invite_link(); ?>"><?php _e( 'Accept', 'buddypress' ); ?></a> &nbsp;
					<a class="btn btn-xs btn-danger reject confirm" href="<?php bp_group_reject_invite_link(); ?>"><?php _e( 'Reject', 'buddypress' ); ?></a>
