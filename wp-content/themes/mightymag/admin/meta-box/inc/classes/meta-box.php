...
if ( ! class_exists( 'RW_Meta_Box' ) )
{
	...
	class RW_Meta_Box
	{
		...
		function admin_enqueue_scripts()
		{
			...
			wp_enqueue_style( 'rwmb', RWMB_CSS_URL . 'style_meta.css', array(), RWMB_VER );
					...
					<script type="text/javascript">
						if ( typeof rwmb == "undefined" )
						{
							var rwmb = {
								...
								summaryMessage : "' . __( 'Please correct the errors highlighted below and try again.', 'mightymag-admin' ) . '"
							};
						}
						else
						{
		...
		static function end_html( $html, $meta, $field )
		{
			...
			$button = '';
			if ( $field['clone'] )
				$button = '<a href="#" class="rwmb-button button-primary add-clone">' . __( '+', 'mightymag-admin' ) . '</a>';
		...
		{
			$button = '<a href="#" class="rwmb-button button remove-clone">' . __( '&#8211;', 'mightymag-admin' ) . '</a>';
