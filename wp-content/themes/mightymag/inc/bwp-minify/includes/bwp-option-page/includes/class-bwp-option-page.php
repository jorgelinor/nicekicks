...
class BWP_OPTION_PAGE {
	...
	function generate_html_form()
	{
		...
		$return_str = '';
		$return_str .= apply_filters('bwp_option_submit_button', '<p class="submit"><input type="submit" class="button-primary" name="submit_' . $this->form_name . '" value="' . __('Save Changes', 'mightymag-admin') . '" /></p>') . "\n";
		$return_str .= '</form>' . "\n";		
		$return_str .= '</div>' . "\n";
