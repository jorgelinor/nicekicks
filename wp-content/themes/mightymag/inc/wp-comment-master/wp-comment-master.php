...
Ajax comments for MightyMag WP Theme by djwd, based on:
   ...
   if(!is_admin()){
      ...
      wp_localize_script('paginating_js','yjlSettings',array(
           ...
           'pagination'=>get_option('com_paging'),
            ...
            'comPerpage'=>of_get_option('mgm_ajax_comments_per_page'),
            ...
            'timeOut'=>'<div class="alert alert-error">'. __('<strong>Error: </strong> server time out, please try again.', 'mightymag').'</div>',

            'fast'=>'<div class="alert alert-block">'. __('<strong>Please</strong> slow down, you are posting to fast!', 'mightymag').'</div>',

            'thank' => '<div class="alert alert-success">'. __('<strong>Thank you</strong> for your comment!', 'mightymag').'</div>',
	...
	<form method="post" action="options.php">
		...
		<table class="form-table">
			...
			<tr valign="top">
				...
				<td><input name="com_per_page" id="com-per-page" value="<?php echo of_get_option('mgm_ajax_comments_per_page'); ?>" />
					<br>
